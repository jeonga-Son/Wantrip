...
function displayPlaces2(places) {
    ...
    for ( var i=0; i<places.length; i++ ) {
            ...
            // 마커를 생성하고 지도에 표시합니다
            var marker2 = addMarker2(new kakao.maps.LatLng(places[i].y, places[i].x), order);
...
function addMarker2(position, order) {
    var imageSrc = 'https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/places_category.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
        ...
        marker2Image = new kakao.maps.MarkerImage(imageSrc, imageSize, imgOptions),
    ...
    markerArray.push(marker2);  // 배열에 생성된 마커를 추가합니다
